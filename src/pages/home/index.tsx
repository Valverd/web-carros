      ...
      <Container>
        <section className="bg-white max-w-3xl p-4 rounded-lg mx-auto drop-shadow flex justify-center items-center gap-4">
          <input
            ...
            className="w-full p-1 border-b outline-none transition duration-300  focus:border-b-red-600"
          />
          <button className="px-4 h-9 rounded-lg bg-red-600 text-white font-medium text-lg duration-300 hover:bg-red-500">
            Buscar
          </button>
        </section>
        ...
        <main className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          <section className="w-full bg-white rounded-lg cursor-pointer transition-all duration-300 shadow-personalized hover:scale-personalized">
            <img
